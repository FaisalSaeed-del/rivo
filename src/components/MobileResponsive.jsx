...
import Logo from "../assets/Rivo.svg";
  ...
  return (
    <div className="wrapper">
      <div className="flex justify-between py-4 px-4">
        ...
        <button className="text-2xl" onClick={toggleDrawer}><CiMenuFries/></button>
      </div>
      ...
      >
        <div className="flex gap-[46px] items-center flex-col py-10 bg-[#6bc785]">
          ...
          <button className="bg-transparent border-[1px] border-black py-1 px-10">
            Login
          </button>
        </div>
      </Drawer>
